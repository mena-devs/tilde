Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "mena-devs_com_#{Rails.env}"
  ...
  config.action_mailer.asset_host = "46.101.47.134"
  ...
  :email => {
    ...
    :sender_address => %{"notifier" <#{AppSettings.sender_email}>},
