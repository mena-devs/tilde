...
class PartnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post partners_url, params: { partner: { active: @partner.active, description: @partner.description, email: @partner.email, external_link: @partner.external_link, name: @partner.name } }
    end
  ...
  test "should update partner" do
    patch partner_url(@partner), params: { partner: { active: @partner.active, description: @partner.description, email: @partner.email, external_link: @partner.external_link, name: @partner.name } }
